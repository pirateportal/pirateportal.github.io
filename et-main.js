...
(function (b) {
	b.fn.waitMe = function (p) {
		return this.each(function () {
				...
				v, a, w, k = {
					init: function () {
						...
						if (0 < d) {
							...
							for (var e = 1; e <= d; ++e) b.isArray(a.color) ? (c = a.color[e], void 0 == c && (c = "#000")) : c = a.color, r = u ? r + ('<div class="waitMe_progress_elem' + e + '"><div style="' + t + ":" + c + '"></div></div>') : r + ('<div class="waitMe_progress_elem' + e + '" style="' + t + ":" + c + '"></div>');
							l = b('<div class="waitMe_progress ' + a.effect + '" style="' + q + '">' + r + "</div>")
						}
						...
						"" !== a.maxSize && (e = l.outerHeight(), l.outerWidth(), "img" === a.effect ? (l.css({
							height: a.maxSize + "px"
						}), l.find(">img").css({
							maxHeight: "100%"
						}), m.css({
						...
						if (f.outerHeight() > b(window).height()) {
							...
							0 > e && (e = Math.abs(e));
							0 <= e - g && e + g <= k ? n - c > b(window).height() / 2 && (e = g) : e = c > n + k - g ? c - n - g : c - n + g;
							y(e);
			...
			if (k[p]) return k[p].apply(this, Array.prototype.slice.call(arguments, 1));
...
var _0x8740 = ["length", "#e_content", "html", "s", "parse", "", "substr", "show", "enc", "decrypt", "AES", "<b class=\"error\">Site content can`t be dispalyed. Please contact us about that error.</b>", "/ajax_searches.php?s=", "blue-light", "easyAutocomplete", "#search,#page_search", "ready"];
$(document)[_0x8740[16]](function () {
	if ($(_0x8740[1])[_0x8740[0]]) {
		try {
			var _0xee19x1 = $("#e_content").html();
			var _0xee19x2 = JSON.parse(_0xee19x1).s;

			//var _0xee19x3 = et();//"070107100006"
			//console.log($("#e_content").next().html());
			//var _0xee19x3 = "070107100006";

			eval($("#e_content").next().html());
			var _0xee19x3 = et();

			var _0xee19x4 = "";
			for (i = 1; i <= _0xee19x3.length / 2; i++) {
				_0xee19x4 += _0xee19x2[parseInt(_0xee19x3.substr(2 * (i - 1), 2))]
			};
			var a = CryptoJS.AES.decrypt(_0xee19x1, _0xee19x4, {
			...
			var c = JSON.parse(b);
			//console.log(c);
			// remove script tags from c.
			c = c.replace(/\<script .+\<\/script\>/g, "");
			$("#e_content").html(c).show();
			document.getElementById("e_content").className = "";
		} catch (e) {
			$("#e_content").html(_0x8740[11]).show()
		}
	};
	$(_0x8740[15])[_0x8740[14]]({
		url: function (_0xee19x5) {
			return _0x8740[12] + _0xee19x5
		},
		theme: _0x8740[13],
		requestDelay: 100
	})
